...
public static class ServiceExtensions
{
    extension (IServiceCollection services)
    {
        ...
        public IServiceCollection RegisterQuestEngineWindowsOcrAutoclicking<I, O, P>()
        ...
        /// </remarks>
        public IServiceCollection RegisterQuestEngineWindowsAutoclickingOnly<P>()
            where P : class, IPostLaunchAction
        {
        ...
        /// </remarks>
        private IServiceCollection RegisterAutoClickServices<P>()
            where P : class, IPostLaunchAction
        {
        ...
        /// </remarks>
        private IServiceCollection RegisterToastQuestEndingServices()
        {
        ...
        /// </remarks>
        private IServiceCollection RegisterDefaultPopups()
        {
        ...
        /// </remarks>
        private IServiceCollection RegisterSpartanMonitoring()
        {
